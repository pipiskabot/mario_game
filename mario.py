...
class Flames:
    ...
    def update(self):
        ...
        if self.flames_img_rect.left > 0:
            ...
            if LEVEL == 2:
                self.flames_velocity = 25
            if LEVEL == 3:
                self.flames_velocity = 30
            if LEVEL == 4:
                self.flames_velocity = 35
...
def check_level(SCORE):
    ...
    if SCORE in range(0, 1):
        cactus_img_rect.bottom = 25
        fire_img_rect.top = WINDOW_HEIGHT - 25
        LEVEL = 1
        ...
        fire_img_rect.top = WINDOW_HEIGHT - 75
        LEVEL = 3
